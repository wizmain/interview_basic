...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    KeychainItemWrapper *passwordWrap = [[KeychainItemWrapper alloc] initWithIdentifier:@"Account" accessGroup:nil];
    self.passwordWrapper = passwordWrap;
    [passwordWrap release];
    ...
    if (self.autoLoginController == nil) {
        AutoLoginController *autoLogin = [[AutoLoginController alloc] initWithNibName:@"AutoLoginController" bundle:nil];
        self.autoLoginController = autoLogin;
        [autoLogin release];
    }
    ...
    if(loginProperties != nil) {
        if(loginProperties.autoLogin){
            [_window setRootViewController:_autoLoginController];
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    NSString *userID = [Utils cookieValue:@"userID"];
    NSLog(@"applicationWillEnterForeground cookies userID=%@", userID);
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"interview_basic" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSError *error = nil;
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"interview_basic.sqlite"];
...
- (void)switchAutoLoginView {
    AutoLoginController *autoLogin = [[AutoLoginController alloc] initWithNibName:@"AutoLoginController" bundle:nil];
    [self.window addSubview:autoLogin.view];
}

- (void)interviewRecordStart:(NSString *)categoryID {
    [self.mainViewController interviewRecordStart:categoryID];
}
