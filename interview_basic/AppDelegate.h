...
@class InterviewRecordViewController;
...
@property (nonatomic, retain) InterviewRecordViewController *interviewRecordController;
...
@property (nonatomic, retain) KeychainItemWrapper *passwordWrapper;
@property (nonatomic, retain) AutoLoginController *autoLoginController;
