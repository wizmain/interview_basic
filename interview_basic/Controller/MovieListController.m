...
- (void)movieListCellButton1Click:(MovieListCell *)cell {
    ...
    ******/
    ...
    /*type2 */
    NSURL *url = [NSURL URLWithString:cell.interview.fileUrl];
    ...
    /*type3
    MPMoviePlayerController *moviePlayer = [[MPMoviePlayerController alloc] initWithContentURL:[NSURL URLWithString:cell.interview.fileUrl]];
